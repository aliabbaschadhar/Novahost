...
export function UptimeMonitor({
  ...
  if (variant === 'dashboard') {
    return (
      <Card className={`bg-gray-900/50 border-gray-800 hover:bg-gray-900/70 transition-all duration-300 ${className}`}>
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-emerald-400">{currentUptime}%</div>
  ...
  return (
    <div className={`bg-gradient-to-br from-gray-900/80 to-black/90 rounded-2xl sm:rounded-3xl p-4 sm:p-8 backdrop-blur-sm border border-gray-800/50 shadow-2xl hover:shadow-emerald-500/10 hover:border-emerald-500/30 transition-all duration-500 group ${className}`}>
      {/* Graph Header */}
